...
The dataset contains 279,712 observations across 33 variables, including 1 date, 9 categorical (originally character but converted to factors), 4 logical, and 19 numeric variables.
...
As a part of the step, we derive several new variables by conducting a text analysis. 
...
Price, Countries
There were only 6 distict countries that this dataset listings were including.
